...
//此处bag包的地址需要自行修改
std::string bagfile = "/home/zy/Downloads/HW4/bag/scan_odom_tf_2021-07-09-09-48-28.bag";
...
public:
    imlsDebug()
    {
        ...
        // scanSub = m_nh.subscribe("scan", 5, &imlsDebug::championLaserScanCallback, this);
        // odomSub = m_nh.subscribe("odom", 5, &imlsDebug::odomCallback, this);
        // m_laserscanSub = m_nh.subscribe("sick_scan",5,&imlsDebug::championLaserScanCallback,this);
    }

    //将激光消息转换为激光坐标系下的二维点云
    void ConvertChampionLaserScanToEigenPointCloud(const sensor_msgs::LaserScanConstPtr& msg, std::vector<Eigen::Vector2d>& eigen_pts)
    ...
    void championLaserScanCallback(const sensor_msgs::LaserScanConstPtr& msg)
